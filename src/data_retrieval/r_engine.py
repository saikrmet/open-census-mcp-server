...
class RDataRetrieval:
    ...
    def _init_core_mappings(self):
        ...
        self.core_mappings = {
            ...
            # Add these to your core_mappings in r_engine.py _init_core_mappings()

        # === AGE DEMOGRAPHICS (B01001 - Sex by Age) ===
        'population_65_and_older': ['B01001_020', 'B01001_021', 'B01001_022', 'B01001_023', 'B01001_024', 'B01001_025', 'B01001_044', 'B01001_045', 'B01001_046', 'B01001_047', 'B01001_048', 'B01001_049'],
        'elderly_population': ['B01001_020', 'B01001_021', 'B01001_022', 'B01001_023', 'B01001_024', 'B01001_025', 'B01001_044', 'B01001_045', 'B01001_046', 'B01001_047', 'B01001_048', 'B01001_049'],
        ...
        'population_over_65': ['B01001_020', 'B01001_021', 'B01001_022', 'B01001_023', 'B01001_024', 'B01001_025', 'B01001_044', 'B01001_045', 'B01001_046', 'B01001_047', 'B01001_048', 'B01001_049'],
        '65_and_older': ['B01001_020', 'B01001_021', 'B01001_022', 'B01001_023', 'B01001_024', 'B01001_025', 'B01001_044', 'B01001_045', 'B01001_046', 'B01001_047', 'B01001_048', 'B01001_049'],
        '65_years_and_older': ['B01001_020', 'B01001_021', 'B01001_022', 'B01001_023', 'B01001_024', 'B01001_025', 'B01001_044', 'B01001_045', 'B01001_046', 'B01001_047', 'B01001_048', 'B01001_049'],

        # Detailed age groups
        'population_65_to_74': ['B01001_020', 'B01001_021', 'B01001_022', 'B01001_044', 'B01001_045', 'B01001_046'],
        'population_75_and_older': ['B01001_023', 'B01001_024', 'B01001_025', 'B01001_047', 'B01001_048', 'B01001_049'],
        'population_85_and_older': ['B01001_025', 'B01001_049'],

        # Child demographics
        'population_under_5': ['B01001_003', 'B01001_027'],
        'population_5_to_17': ['B01001_004', 'B01001_005', 'B01001_006', 'B01001_028', 'B01001_029', 'B01001_030'],
        'children_population': ['B01001_003', 'B01001_004', 'B01001_005', 'B01001_006', 'B01001_027', 'B01001_028', 'B01001_029', 'B01001_030'],
        'minors': ['B01001_003', 'B01001_004', 'B01001_005', 'B01001_006', 'B01001_027', 'B01001_028', 'B01001_029', 'B01001_030'],

        # Working age
        'working_age_population': ['B01001_007', 'B01001_008', 'B01001_009', 'B01001_010', 'B01001_011', 'B01001_012', 'B01001_013', 'B01001_014', 'B01001_015', 'B01001_016', 'B01001_017', 'B01001_018', 'B01001_019', 'B01001_031', 'B01001_032', 'B01001_033', 'B01001_034', 'B01001_035', 'B01001_036', 'B01001_037', 'B01001_038', 'B01001_039', 'B01001_040', 'B01001_041', 'B01001_042', 'B01001_043'],
        'population_18_to_64': ['B01001_007', 'B01001_008', 'B01001_009', 'B01001_010', 'B01001_011', 'B01001_012', 'B01001_013', 'B01001_014', 'B01001_015', 'B01001_016', 'B01001_017', 'B01001_018', 'B01001_019', 'B01001_031', 'B01001_032', 'B01001_033', 'B01001_034', 'B01001_035', 'B01001_036', 'B01001_037', 'B01001_038', 'B01001_039', 'B01001_040', 'B01001_041', 'B01001_042', 'B01001_043'],

        # === POVERTY STATUS (B17001 - Poverty Status) ===
        'below_poverty_line': 'B17001_002',
        'poverty_universe': 'B17001_001',
        'above_poverty_line': 'B17001_003',
        'child_poverty': 'B17001_004',
        'senior_poverty': 'B17001_015',
        'poverty_status': 'B17001_001',
        'people_in_poverty': 'B17001_002',

        # === EMPLOYMENT STATUS (B23025 - Labor Force) ===
        'labor_force_participation_rate': 'B23025_002',
        'employment_rate': 'B23025_004',
        'not_in_labor_force': 'B23025_007',
        'civilian_labor_force': 'B23025_002',
        'employed_population': 'B23025_004',
        'unemployed_population': 'B23025_005',

        # === DETAILED RACE/ETHNICITY (B03002 - Hispanic Detail) ===
        'non_hispanic_white': 'B03002_003',
        'hispanic_or_latino': 'B03002_012',
        'non_hispanic_black': 'B03002_004',
        'non_hispanic_asian': 'B03002_006',
        'non_hispanic_american_indian': 'B03002_005',
        'non_hispanic_pacific_islander': 'B03002_007',
        'non_hispanic_other': 'B03002_008',
        'non_hispanic_two_or_more': 'B03002_009',

        # === HOUSING DETAIL ===
        'homeowner_vacancy_rate': 'B25004_002',
        'rental_vacancy_rate': 'B25004_008',
        'housing_density': 'B25001_001',
        'owner_occupied_housing': 'B25003_002',
        'renter_occupied_housing': 'B25003_003',
        'vacant_for_rent': 'B25004_002',
        'vacant_for_sale': 'B25004_003',

        # === NATURAL LANGUAGE VARIATIONS ===
        'how_many_elderly': ['B01001_020', 'B01001_021', 'B01001_022', 'B01001_023', 'B01001_024', 'B01001_025', 'B01001_044', 'B01001_045', 'B01001_046', 'B01001_047', 'B01001_048', 'B01001_049'],
        'older_adults': ['B01001_020', 'B01001_021', 'B01001_022', 'B01001_023', 'B01001_024', 'B01001_025', 'B01001_044', 'B01001_045', 'B01001_046', 'B01001_047', 'B01001_048', 'B01001_049'],
        'aging_population': ['B01001_020', 'B01001_021', 'B01001_022', 'B01001_023', 'B01001_024', 'B01001_025', 'B01001_044', 'B01001_045', 'B01001_046', 'B01001_047', 'B01001_048', 'B01001_049'],
        'retirement_age': ['B01001_020', 'B01001_021', 'B01001_022', 'B01001_023', 'B01001_024', 'B01001_025', 'B01001_044', 'B01001_045', 'B01001_046', 'B01001_047', 'B01001_048', 'B01001_049'],

        'poverty_percentage': 'B17001_002',
        'percent_below_poverty': 'B17001_002',
        'poor_people': 'B17001_002',
        'low_income': 'B17001_002',

        'jobless_rate': 'B23025_005',
        'out_of_work': 'B23025_005',
        'labor_participation': 'B23025_002',
        'workforce': 'B23025_002',
        }
